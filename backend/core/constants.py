...
# Professional counter journey (customer drop-off → repair → ready → handover).
# Status is still ONE field, one value at a time (spec section 4).
STATUS_CHOICES = [
    "Received",  # device taken in from the customer
    "In Progress",  # diagnosing / fixing
    "Ready",  # ready for the customer to collect
...
# Customer-facing wording for the public track page (QR on the receipt).
STATUS_CUSTOMER_COPY = {
    "Received": {
        "title": "Device received",
        "detail": "We've checked your device in and it's queued for repair.",
        "step": 1,
    },
    "In Progress": {
        "title": "Repair in progress",
        "detail": "Our technician is working on your device now.",
        "step": 2,
    },
    "Ready": {
    ...
    "Collected": {
        "title": "Collected",
        "detail": "You've collected your device. Thank you for choosing us.",
        "step": 4,
    },
    "Not Agreed/Fixed - In Shop": {
        "title": "Waiting at the shop",
        "detail": "Your device is at the shop awaiting collection.",
        "step": 3,
    },
    "Not Agreed/Fixed - Collected": {
        "title": "Collected",
...
# Short labels for staff status buttons (detail screen).
STATUS_STAFF_HINTS = {
