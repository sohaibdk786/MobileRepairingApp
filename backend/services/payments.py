...
backend.services.financials -- never stored as a fixed column.
"""
import sqlite3
from datetime import datetime

from backend.core.constants import PAYMENT_METHODS
...
def add_refund(conn: sqlite3.Connection, *, ticket: str, amount_pence: int, method: str) -> None:
    ...
    computed from (see backend.services.financials), so a refund correcting the real
